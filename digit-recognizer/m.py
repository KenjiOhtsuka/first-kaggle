...
train_x = train.iloc[:, 1:].values.astype('float32')  # numpy.ndarray
train_y = np.identity(10)[
    train.iloc[:, 0].values.astype('int32')]  # numpy.ndarray

print(train_x.shape)
print(train_y.shape)
test_x = test.values.astype('int32')
